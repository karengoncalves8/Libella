        ...
        <View style={{ flex: 1, backgroundColor: '#F2F2F2' }}>
            <DrawerContentScrollView {...props}
                ...
                <View style={{
                    ...
                    <Text style={{ fontSize: 24, paddingLeft: 5, color: '#53A7D7', fontFamily: 'Comfortaa_700Bold' }}>Libella</Text>
                </View>
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => { }} style={{ flexDirection: 'row', gap: 10, alignItems: 'center', }}>
                    ...
                    <Text style={{ fontSize: 20, color: '#EC4646', fontFamily: 'Poppins_500Medium', }}>Sair</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
